...
We are currently (a) using simulation experiments to examine and separate the relative influence of temperature and net primary productivity on future projections, and (b) beginning simulations for the ISIMIP 3a/b simulation round, using CMIP6 forcing data. FishMIP model outputs from simulation round 2(a) are publicly available and can be found [**here**](http://doi.org/10.5880/PIK.2018.005). You are welcome to use these data in your projects, but we encourage you to contact the FishMIP modellers and coordinators whose work you have been using, and to reference the [**publications**](https://fish-mip.github.io/publications.html) which provide further details.
