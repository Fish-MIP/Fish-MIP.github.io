...
![Image credit: Boyce, D. G., Schleit, K. & Fuller, S. Incorporating climate change into fisheries management in Atlantic Canada and the Eastern Arctic. Oceans North Report. (2021).](FISHMIP.max-1200x1200.png){style="text-color:light-grey;text-font:0.25px"}

#### **Ongoing studies: FishMIP 2.0**

We are currently running simulation experiments to evaluate models for how well they can detect past ecosystem and fisheries changes and to work towards an attribution framework. Our major improvements over past protocols include: 1) standardised global fishing drivers and 2) improved representation of coastal processes in our climate forcings.

More information on our current protocol can be found [**here**](protocols.html).

FishMIP model outputs from past simulation rounds can be found [**here**](data.isimip.org). You are welcome to use these data in your projects, but we strongly encourage you to contact the FishMIP modellers and coordinators whose work you have been using, and to reference the [**publications**](https://fish-mip.github.io/publications.html) which provide further details.
