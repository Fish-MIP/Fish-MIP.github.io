...
[[Country-level Ensemble Model Outputs]{.underline}](https://rstudio.global-ecosystem-model.cloud.edu.au/shiny/FAO_report_shiny/){.email-link} Check out our Shinyapp (beta version) to visualise spatially aggregated data of projected changes in potential fish biomass, under alternative climate emission scenarios.

[[Input Explorer for Regional Modellers]{.underline}](https://rstudio.global-ecosystem-model.cloud.edu.au/shiny/FishMIP_Input_Explorer/){.email-link} A Shinyapp to examine inputs per regional ecosystem model domain.
