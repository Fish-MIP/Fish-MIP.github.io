---
pagetitle: Working Groups | FishMIP
description-meta: |
    To advance FishMIP 2.0 we are in the process of establishing several Working Group Projects.
---
...
* [WG1: Model improvement & data tools](workinggroups.qmd#sec-wg1)
* [WG2: Socio-economic scenarios](workinggroups.qmd#sec-wg2)
* [WG3: Food security](workinggroups.qmd#sec-wg3)
* [WG4: Biodiversity protection](workinggroups.qmd#sec-wg4)
* [WG5: Climate change mitigation](workinggroups.qmd#sec-wg5)

![Figure adapted from [Blanchard & Novaglio (2024)](https://doi.org/10.4060/cd1379en){target="_blank"}, *Climate change risks to marine ecosystems and fisheries: Projections to 2100 from the Fisheries and Marine Ecosystem Model Intercomparison Project*.](../images/FAO_report_figure_20_v2_small.png){width="85"}

## WG1: Model improvement & data tools {#sec-wg1}
...
**Leads:** Ryan Heneghan ([r.heneghan@griffith.edu.au](mailto:r.heneghan@griffith.edu.au)) & Daniël van Denderen ([pdvd@aqua.dtu.dk](mailto:pdvd@aqua.dtu.dk))

## WG2: Socio-economic scenarios {#sec-wg2}
...
Leads: Olivier Maury ([olivier.maury@ird.fr](mailto:olivier.maury@ird.fr)), Derek Tittensor ([derek.tittensor@dal.ca](mailto:derek.tittensor@dal.ca)) & Tyler Eddy ([tyler.eddy@mi.mun.ca](mailto:tyler.eddy@mi.mun.ca))

## WG3: Food security {#sec-wg3}
...
**Leads:** Camilla Novaglio ([camilla.novaglio@leibniz-zmt.de](mailto:camilla.novaglio@leibniz-zmt.de)) & Julia Blanchard ([Julia.blanchard@utas.edu.au](mailto:Julia.blanchard@utas.edu.au))

## WG4: Biodiversity protection {#sec-wg4}
...
## WG5: Climate change mitigation {#sec-wg5}
...
**Lead**: Cheryl Harrison ([chsharrison@gmail.com](mailto:chsharrison@gmail.com))

If you are interested in finding out more please contact WG leads or [fishmip.coordinators@gmail.com](mailto:fishmip.coordinators@gmail.com)
:::